...
public class FCMHelper {
     ...
     */
    private static final String FCM_SERVER_KEY = "AIzaSy***VRqO9udC7E";
    ...
    private String sendFcmMessage(JsonObject sendObject, JsonObject notificationObject, JsonObject dataObject) throws IOException {
        ...
        HttpHost proxy = new HttpHost(MyUtils.PROXY_IP,MyUtils.PROXY_PORT);
        ...
        httpPost.setHeader("Authorization", "key=" + new SecurityUtils().getFcmServerKey());
        ...
        Log.debug("send to FCM json: ",data);
